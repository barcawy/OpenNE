# VERSE: Versatile Graph Embeddings from Similarity Measures, WWW, 2018
...
class _LINE(object):
    ...
    def __init__(self, graph, rep_size = 128, negative_ratio = 5):
        self.cur_epoch = 0
        self.g = graph
    ...
    def train_one_epoch(self):
        # Verse文中提到 10^5 times =  n_nodes * epochs
        sum_loss = 0.0
...
class verse(object):
    ...
    def __init__(self, graph, rep_size=128, epoch = 50, negative_ratio=3):
        self.rep_size = rep_size
        self.model = _LINE(graph, rep_size, negative_ratio)
